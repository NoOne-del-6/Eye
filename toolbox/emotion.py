        ...
        if self.data is not None:
            try:
                ...
                background_image_paths = [
                    r'C:\Users\Lhtooo\Desktop\生理信号分析\code\images\拼接\1.jpg',
                    r'C:\Users\Lhtooo\Desktop\生理信号分析\code\images\拼接\2.jpg',
                    r'C:\Users\Lhtooo\Desktop\生理信号分析\code\images\拼接\3.jpg',
                    r'C:\Users\Lhtooo\Desktop\生理信号分析\code\images\拼接\4.jpg'
                ]
            ...
            try:
             ...
             # 生成优化后的统计字符串
                statistics_str = (
                    ...
                    f"<b><font size='5' color='#9B51E0'>左眼瞳标准差:</font></b> <font size='5' color='#333333'>{std_diff_left:.4f}</font><br>"
                    f"<b><font size='5' color='#F39C12'>右眼瞳标准差:</font></b> <font size='5' color='#333333'>{std_diff_right:.4f}</font><br>"
